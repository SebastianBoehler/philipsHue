...
class philipsHue {
    ...
    async getAccessToken(code, grant_type = 'authorization_code') {
    ...
    async shouldRefreshAccessToken(aboutToExpireInNextSeconds = 90) {
        const now = new Date();
